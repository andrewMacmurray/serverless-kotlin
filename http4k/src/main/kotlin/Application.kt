...
object Application {
    val handler = routes(
        "/hello" bind GET to { Handlers.hello() },
        "/bread" bind GET to { Handlers.bread() },
        "/body" bind POST to Handlers::body,
        "/fancy-bread" bind POST to jsonHandler(Handlers::fancyBread)
    )
}
